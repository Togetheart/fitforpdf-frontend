        ...
        {isOptionsExpanded ? (
          ...
          >
            <div className="min-h-0 divide-y divide-[var(--color-border)]">
              ...
              <SettingRow title="Branding" description="Adds a small “Generated by FitForPDF” credit to the footer." checked={includeBranding} onChange={handleBrandingChange} rowTestId="setting-row-branding" disabled={isLoading} />
