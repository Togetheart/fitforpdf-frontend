...
export default function SiteHeader() {
  return (
    <header
      ...
      className="fixed left-0 right-0 top-0 z-50 w-full border-b border-slate-200/60 bg-white/60 backdrop-blur-xl ring-1 ring-black/5 supports-[backdrop-filter]:bg-white/50"
    >
